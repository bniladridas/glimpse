...
You can copy the underlying source code of the selected icon to use in other developments. Buttons are provided to copy either a clean React component import snippet or the raw SVG markup directly to your clipboard.
